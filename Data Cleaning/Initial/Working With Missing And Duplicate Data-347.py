...
happiness2015.columns = happiness2015.columns.str.replace('.', ' ').str.replace(r'[\(\)]', '').str.strip().str.upper()
happiness2016.columns = happiness2016.columns.str.replace('.',' ').str.replace(r'[\(\)]', '').str.strip().str.upper()
