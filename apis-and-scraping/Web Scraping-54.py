...
header_parser = parser.find_all("head")
title = header_parser[0].find_all('title')
...
patriots_total_plays = parser.select('#total-plays')[0]
patriots_total_plays_count = patriots_total_plays.select('td')[2].text
print(patriots_total_plays_count)

seahawks_total_yards = parser.select('#total-yards')[0]
seahawks_total_yards_count = seahawks_total_yards.select('td')[1].text