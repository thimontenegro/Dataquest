...
first_tree = clf.predict(test[columns])

second_tree = clf2.predict(test[columns])

auc_score_1 = roc_auc_score(test['high_income'], first_tree)

auc_score_2 = roc_auc_score(test['high_income'], second_tree)
...
result = ((predictions + predictions2) / 2 )
